	...
	<div className={styles.content}>
		...
		<div className={styles.textContent.top}>
			<Description>
				...
				<br />
				<br />
				Наш бренд-шеф Алексей Федин проходил обучение в&nbsp;институте Поля Бокюза и&nbsp;каждый день придумывает новое меню в&nbsp;зависимости от&nbsp;сезонности и&nbsp;фермерских поставок.
				<br />
				<br />
		...
		<div className={styles.imageContainer}>
			<Image fill src="/images/chto-my-edim-coffe.webp" alt="кофейня «Трикстер»" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw" className={styles.image} unoptimized />
		</div>
		<h2 className={uikit.titleVaryingSize}>Что мы пьём</h2>
		<br />
		<WhatWeDrinkBlock />
		<div className={styles.imageContainer}>
			<Image fill src="/images/chto-edim/coffe.webp" alt="бар «я догоню»" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw" className={styles.image} unoptimized />
		</div>
	</div>
);
