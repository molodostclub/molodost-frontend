	...
	<div className={styles.content}>
      ...
      <AdditionalServicesSide />
		...
		<div className={styles.textContent.bottom}>
			<Description>
				У&nbsp;нас приличная винная карта и&nbsp;большой выбор крепкого алкоголя. Мы&nbsp;верим, что воздух Алтая пьянит и&nbsp;дурманит сам по&nbsp;себе, поэтому цены в&nbsp;нашем баре специально высокие: коктейли от&nbsp;1000&nbsp;₽&nbsp;/ шт; вина от&nbsp;1&nbsp;000&nbsp;₽&nbsp;/ бокал;
				и&nbsp;любой крепкий алкоголь на&nbsp;выбор по&nbsp;500&nbsp;₽ за&nbsp;70&nbsp;грамм.
				<br />
				<br />
