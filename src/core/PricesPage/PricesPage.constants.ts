...
export const CORPORATIVE_PRICE: HeatLabModel[] = [
  {
    ...
    subtitle:
      '(автопарк без бензина, водители следопыты, все дома, (кроме дома 1), баня с групповыми парениями +чан, аренда всех пространств, культурная программа, которую мы делаем своими силами, трехразовое питание)',
