export const OUR_BASE_ITEMS = [
  {
    imageSrc: '/images/baza/baza-1.jpeg',
    title: 'Конторский дом',
  ...
  {
    imageSrc: '/images/baza/trikster.jpg',
    title: 'Трикстер',
    description: 'Кофейня и концепт стор.',
  },
  {
    imageSrc: '/images/baza/blagodat.jpg',
