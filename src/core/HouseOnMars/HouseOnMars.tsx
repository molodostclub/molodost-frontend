		...
		<Container className={indent.mt_6}>
			...
			<div className={cn(indent.tablet_mt_15, indent.mt_6)}>
				<Description>
					...
					<br />
					<br />
					При этом на&nbsp;закупку воды Петроглиф и&nbsp;переработку пластика, который возим в&nbsp;Новосибирск, мы&nbsp;тратим миллионы рублей в&nbsp;год. Поэтому посчитали справедливым включать в&nbsp;ваш счёт водяной сбор 350&nbsp;рублей. Все деньги, которые мы&nbsp;получим за&nbsp;эту
