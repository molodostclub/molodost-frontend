	...
	return (
		<div className={styles.shell}>
			<div className={styles.content}>
				...
				<p className={styles.description}>
					Раньше она была японским рыболовным заводом, а после перехода острова к России стала лесопилкой, такой мы её приобрели, и сделаем её гостевым пространством в стиле «Молодости».
					<br />
					<br />
					Лесопилка станет центральным общественным местом общей площадью 640&nbsp;м².
					<br />
					<br />
					Она объединит: гастротрактир, ресепшн, кофейню, концепт стор (магазин с нашей фирменной продукцией), гостиную и кинотеатр.
					<br />
					<br />
