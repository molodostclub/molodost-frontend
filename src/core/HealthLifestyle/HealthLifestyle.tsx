	...
	<div className={styles.content}>
		...
		<div className={cn(styles.imagesGrid, indent.mt_6)}>
			<div className={styles.imageWrapper}>
				<Image fill src="/images/odissey-card.webp" alt="спортивный зал «Одиссей»" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw" className={styles.image} unoptimized />
			</div>
			<div className={styles.imageWrapper}>
				<Image fill src="/images/zom/zom2.webp" alt="спортивный зал «Одиссей»" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw" className={styles.image} unoptimized />
			</div>
			<div className={styles.imageWrapper}>
				<Image fill src="/images/zom/zom3.webp" alt="спортивный зал «Одиссей»" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw" className={styles.image} unoptimized />
			</div>
			<div className={styles.imageWrapper}>
				<Image fill src="/images/zom/zom4.webp" alt="спортивный зал «Одиссей»" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw" className={styles.image} unoptimized />
			</div>
		</div>
		<div>
