	...
	return (
		...
		<div className={styles.content}>
			...
			<section className={styles.ourBaseSection}>
				...
				<p className={styles.ourBaseDescription}>
					Центром нашей экосистемы является культурная турбаза &laquo;Молодость&raquo;,
					которая находится всего в&nbsp;15&nbsp;минутах езды от&nbsp;аэропорта
					Горно-Алтайск на&nbsp;берегу реки Катуни. На&nbsp;территории турбазы
					расположены:
				</p>
			...
			<div className={styles.travelBlockWrapper}>
				<div className={styles.travelBlock}>
					...
					<div className={styles.travelBlockContent}>
						<h2 className={styles.travelBlockTitle}>КАК МЫ ПУТЕШЕСТВУЕМ</h2>
						<BrandLink linkTo="/kak-my-puteshevstvuem" direction="right" size="small">Подробнее</BrandLink>
					</div>
				</div>
			</div>
