			...
			<div className={styles.textContent}>
				...
				<div className={styles.grid}>
					<div className={styles.itemImageWrapper}>
						<Image fill src="/images/blagodat/blagodat-1.webp" alt="Банный комплекс «БлагодатЪ»" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw" className={styles.image} unoptimized />
					</div>
					<div className={styles.itemImageWrapper}>
						<Image fill src="/images/blagodat/blagodat-2.webp" alt="Банный комплекс в «Молодости»" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw" className={styles.image} unoptimized />
					</div>
				</div>
			</div>
			<br />
