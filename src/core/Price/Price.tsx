    ...
    <Container className={indent.mt_6}>
      ...
      <div className={indent.mt_10}>
        ...
        <Description colorBrand>
          Каждый дополнительный человек в&nbsp;спальне и&nbsp;доме: +7&nbsp;500&nbsp;₽ взрослый; +4&nbsp;500&nbsp;₽ ребенок от&nbsp;5&nbsp;до&nbsp;12&nbsp;лет. Дети до&nbsp;5&nbsp;лет&nbsp;&mdash; комплиментарно.
        </Description>
        <div className={styles.separator}></div>
      </div>
      ...
      <div className={indent.mt_10}>
        ...
        <FlexContainer
          ...
          flexWrap='wrap'
          gap={20}
          className={indent.mt_6}
        >
          <div className={styles.festivalItem}>
            <SectionHeading size='S' color='brand'>“10 дней нового года”</SectionHeading>
            <SectionHeading size='S'>25 декабря – 15 января</SectionHeading>
          </div>
          <div className={styles.festivalItem}>
            <SectionHeading size='S' color='brand'>“45 дней лета”</SectionHeading>
            <SectionHeading size='S'>15 июля – 30 августа</SectionHeading>
          </div>
          <div className={styles.festivalItem}>
            <SectionHeading size='S' color='brand'>майская “искра”</SectionHeading>
      ...
      <div className={indent.mt_10}>
        ...
        <div className={indent.mt_5}>
          <Description>
            В эти даты база работает только для групповых заездов по предварительному бронированию.<br />
      ...
      <div className={indent.mt_20}>
        <SectionHeading size='M' color='brand'>что едим?</SectionHeading>
      </div>
      ...
      <div className={cn(indent.mt_5, indent.mb_5)}>
        <Description>
          А если рыбаки сегодня не привезли, то всегда можно взять:
        </Description>
      </div>
      ...
      <div className={indent.mt_20}>
        <SectionHeading size='M' color='brand'>что пьем?</SectionHeading>
      </div>
      ...
      <div className={cn(indent.mt_5, indent.mb_5)}>
        <Description>
          И обязательно попробуйте наши фирменные угощения:
        </Description>
      </div>
      ...
      <div className={cn(indent.mt_5, indent.mb_5)}>
        <Description>
          У нас приличная винная карта и большой выбор крепкого алкоголя. Мы верим, что воздух Алтая пьянит и дурманит сам по себе, поэтому цены в нашем баре специально высокие:
        </Description>
      </div>
      ...
      <div className={indent.mt_10}>
        <div className={styles.separator}></div>
        <Description colorBrand>
          Если вы&nbsp;приносите алкоголь с&nbsp;собой, наш пробковый сбор составляет 1&nbsp;000&nbsp;₽ с&nbsp;бутылки слабого алкоголя и&nbsp;5&nbsp;000&nbsp;₽ за&nbsp;крепкий.
        </Description>
        <div className={styles.separator}></div>
      </div>
      ...
      <div className={indent.mt_10}>
        <div className={styles.separator}></div>
        <Description colorBrand>
          Если вам что-то хочется, а&nbsp;мы&nbsp;об&nbsp;этом еще не&nbsp;подумали&nbsp;&mdash; скажите нам, и&nbsp;мы&nbsp;вместе решим сколько это будет стоить.
        </Description>
        <div className={styles.separator}></div>
      </div>
      ...
      <div className={indent.mt_10}>
        <div className={styles.separator}></div>
        <Description colorBrand>
          С&nbsp;9:00 до&nbsp;12:00 фильтр кофе включен в&nbsp;ваш завтрак в&nbsp;любом количестве. Полный ассортимент и&nbsp;цены уточняйте за&nbsp;нашей стойкой кофейни.
        </Description>
        <div className={styles.separator}></div>
      </div>

      <div className={indent.mt_10}>
        <SectionHeading size='M' color='brand'>некоторые позиции</SectionHeading>
      </div>
      ...
      <div className={indent.mt_5}>
        <SectionHeading size='M' color='brand'>фитнес</SectionHeading>
      </div>
      ...
      <div className={indent.mt_10}>
        <SectionHeading size='M' color='brand'>движение</SectionHeading>
      </div>
      ...
      <Description className={indent.mt_5} element='div'>
        ...
        <ul className={styles.list}>
          ...
          <li className={styles.listItem}>
            Домашний и уличный кинотеатры
          </li>
          <li className={styles.listItem}>
            Спортивные игры
          </li>
          <li className={styles.listItem}>
            Услуги няни (стоимость обсуждается индивидуально)
          </li>
        </ul>
      </Description>
      ...
      <Description className={indent.mt_5}>
        А еще не забудьте заглянуть в наш Concept Store, в котором собраны брендированный мерч “Молодости” и премиальные алтайские сувениры.
      </Description>


      <div className={indent.mt_10}>
        <SectionHeading size='M' color='brand'>рекомендуем приобрести:</SectionHeading>
      </div>
      ...
      {tours && tours.map(item => (
        <div key={item.title}>
          <div className={cn(indent.tablet_mt_10, indent.mt_6)}>
            <SectionHeading size='M' color='brand'>{item.title}</SectionHeading>
          </div>
          <FlexContainer
            className={cn(indent.tablet_mt_5, indent.mt_2)}
            key={item.title}
          ...
          >
            ...
            <div className={styles.toursRightCol}>
              ...
              <div className={cn(indent.tablet_mt_3, indent.mt_1)}>
                <SectionHeading size='S' color='brand'>{item.priceInfo}</SectionHeading>
              </div>
            </div>
          </FlexContainer>
        </div>
      ...
      <div className={indent.mt_10}>
        <SectionHeading size='M' color='brand'>сопровождающие</SectionHeading>
      </div>
      ...
      <div className={indent.mt_10}>
        ...
        <Description colorBrand>
          ...
          <br />
          <br />
          В организации корпоративных заездов нам помогает наш постоянный партнер Агентство «Маури», которые берут сервисный сбор 10% начиная от 12 человек.
          {/*При оплате по карте за экваринг банка 2,3%.*/}
        </Description>
